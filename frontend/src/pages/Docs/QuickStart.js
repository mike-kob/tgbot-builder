    ...
    <main className={classes.root}>
      ...
      <Box pl={7} pt={4} maxWidth={700} className={classes.content}>
        ...
        <Typography variant="body2">
          ...
          with <Link href="https://t.me/BotFather" target="_blank" rel="noopener nofollow">BotFather</Link>.
        ...
        <Typography variant="body2">
          Now, lets go
          to <Link href="/bots" target="_blank">My bots</Link> page and
        ...
        <Typography variant="body2">
          ...
          Because of security settings of Telegram users must contact bots first with <code>/start</code> command.
          That’s why only one command is available in this state.
        </Typography>
        <Typography variant="body2">
          Let’s add a new state &quot;Echo&quot;.
          And add an action to <code>/start</code> command to change state to &quot;Echo&quot;.
        ...
        <Typography variant="body2">
          ...
          <code>/.*/</code> which will match all messages and add action Send message.
        </Typography>
        <Image
          alt="Message trigger"
